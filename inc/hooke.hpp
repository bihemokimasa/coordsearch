...
template <class Cont>
double best_nearby(const std::function<double(Cont &, void *)> &f,
									 Cont &delta, Cont &point, int &funevals,
									 const double &prevbest, void *params)
// 		double delta[VARS],
// 		point[VARS];
// double prevbest;
// int nvars;
...
template <class Cont>
int hooke(const std::function<double(Cont &, void *)> &f,
					const Cont &startpt,
					Cont &endpt,
					double &steplength,
					int &iters,
					...
					int itermax, void *params, const bool display = true)
// 		double startpt[VARS],
// 		endpt[VARS];
// int nvars, itermax;
// double rho, epsilon;
{
	...
	Cont delta{Cont(nvars)};
	double newf, fbefore, tmp;
	Cont xbefore{Cont(nvars)}, newx{Cont(nvars)};
	...
	while ((iters < itermax) && (steplength > epsilon))
	{
		...
		newf = best_nearby(f, delta, newx, funevals, fbefore, params);
